...
export default function DeleteDialog(props) {
    ...
    const handleDelete = () => {
        if (input === props.parentFunc.name) {
            setResult({
                status: '',
                body: {}
            })
            ...
            const url = `/api/function/${props.parentFunc.name}`;
        ...
        <div>
            ...
            >
                <DialogTitle id="alert-dialog-title">
                    Are you sure to delete <span style={{ color: 'blue', fontWeight: 'bold' }}>{props.parentFunc.name}</span> function?
                </DialogTitle>
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        Please enter <span style={{ color: 'blue', fontWeight: 'bold' }}>{props.parentFunc.name}</span> below to delete this function:
                        {waiting ? (
